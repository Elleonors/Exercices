...
Tu peux dire à SQL de limiter le nombre de résultats, en ajoutant le mot-clef `LIMIT`suivi de la rangée de départ (on commence à 0 en général) puis une virgule, puis le nombre de rangées à garder.
